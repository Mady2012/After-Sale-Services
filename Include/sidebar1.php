<section id="menu">
        ...
        <div class= "items">
            <li><i class="fa fa-dashboard"></i><a href="dash.php">User_Dashboard</a></p></li>
            ...
            <li><i class="fa fa-bars-progress"></i><a href="#">Progress</a></p></li> -->
            <button><li><a href="disconnect.php">Logout</a></li></button>
